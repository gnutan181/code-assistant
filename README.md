# Step-1
     import or download the code from Github
     
# Step-2
      On Terminal 1  -Run the Command: npm i 
         then run: npm run dev

# Step-3 (optional because backend is hosted separately and if you want to run it locally then go for this step-3)
